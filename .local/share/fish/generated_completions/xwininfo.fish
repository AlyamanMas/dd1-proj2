# xwininfo
# Autogenerated from man page /nix/store/7v07bmyfjq0jdnx6xwxlib05na8kksdf-xwininfo-1.1.4/share/man/man1/xwininfo.1.gz
complete -c xwininfo -o help -d 'Print out the `Usage:\' command syntax summary. PP'
complete -c xwininfo -o id -d 'This option allows the user to specify a target window id on the command line…'
complete -c xwininfo -o name -d 'This option allows the user to specify that the window named name is the targ…'
...
complete -c xwininfo -o display -d 'This option allows you to specify the server to connect to; see X(7).  PP'
